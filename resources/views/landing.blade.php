  ...
  @php
    $orgSchema = [
      ...
      'sameAs' => [
        ...
        'https://www.tiktok.com/@fekra__store'
      ],
    ];
      ...
      <div class="grid md:grid-cols-4 gap-12 mb-12">
        ...
        <div class="md:col-span-2">
          ...
          <div class="flex gap-3">
            <a href="https://www.tiktok.com/@fekra__store" target="_blank" class="w-12 h-12 bg-white/10 hover:bg-brand-rose rounded-full flex items-center justify-center transition-all hover:scale-110 group" aria-label="TikTok">
